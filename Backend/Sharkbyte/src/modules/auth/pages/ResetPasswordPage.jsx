    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-sb-bg px-4">
        <div className="text-center space-y-4">
          <p className="text-gray-500 text-sm">Enlace de recuperación inválido o expirado.</p>
          <Link to="/forgot-password" className="text-sb-primary hover:text-sb-secondary text-sm font-medium">
            Solicitar uno nuevo →
          </Link>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-gray-500">Tu contraseña se actualizó correctamente. Ya puedes iniciar sesión.</p>
              <Link
                to="/login"
            ...
            <>
              ...
              <p className="text-gray-500 text-sm mb-6">Ingresa y confirma tu nueva contraseña.</p>
